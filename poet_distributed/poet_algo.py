...
class MultiESOptimizer:
    def __init__(self, args):
        ...
        params.save_genome('/home/TUE/20191160/ant_poet/rs1/cppngenomes_admitted_poet/', env.name)
        ...
        if iteration > 0 and iteration % steps_before_adjust == 0:
            ...
            for child in child_list:
                ...
                if self.pass_mc(score_child):  # check mc
                    ...
                    new_cppn_params.save_genome('/home/TUE/20191160/ant_poet/rs1/cppngenomes_admitted_poet/', new_env_config.name)
                    admitted += 1
