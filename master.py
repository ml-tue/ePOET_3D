...
def run_main(args):
    ...
    if args.algs == 'poet':
        from poet_distributed.poet_algo import MultiESOptimizer
    # elif args.algs == 'poet-ns':
    #     from poet_distributed.poet_algo_ns import MultiESOptimizer
    elif args.algs == 'poet-sac':
        from poet_distributed.poet_algo_sac import MultiESOptimizer
    else:
        print("Please input the correct algorithm (poet, poet-ns, or poet-sac)")
        return
...
def main():
    ...
    parser.add_argument('--algs', default='poet-sac')
    ...
    parser.add_argument('--mc_lower', type=int, default=500)
    parser.add_argument('--mc_upper', type=int, default=3000)
    parser.add_argument('--repro_threshold', type=int, default=2000)
